...
const BasicInfo = ({ name, logo, onInputChange, onLogoChange,onLogoNameChange  }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          type="file"
          onChange={handleFileUpload} // Handle manual file upload
          className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500"
        />
        {logo && (
          <div className="mt-4">
            ...
            <img
              src={logo} // This will show either the URL from asset manager or the base64 preview
              alt="Logo Preview"
